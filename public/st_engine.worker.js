...
console.log("[SUPERTONIC_WORKER_V14] Initializing public classic worker...");
...
self.onmessage = async (e) => {
    ...
    console.log("[SUPERTONIC_WORKER_V14] Received message:", type);
    ...
    try {
        ...
        console.error("[SUPERTONIC_WORKER_V14] Error:", err);
...
async function loadModels() {
    ...
    console.log("[SUPERTONIC_WORKER_V14] Fetching config...");
    ...
    console.log("[SUPERTONIC_WORKER_V14] Fetching indexer...");
    ...
    console.log("[SUPERTONIC_WORKER_V14] Loading models sequentially...");

    console.log("[SUPERTONIC_WORKER_V14] Loading duration_predictor.onnx...");
    const dp = await ort.InferenceSession.create(`${basePath}/duration_predictor.onnx`, options);

    console.log("[SUPERTONIC_WORKER_V14] Loading text_encoder.onnx...");
    const textEnc = await ort.InferenceSession.create(`${basePath}/text_encoder.onnx`, options);

    console.log("[SUPERTONIC_WORKER_V14] Loading vector_estimator.onnx...");
    const vectorEst = await ort.InferenceSession.create(`${basePath}/vector_estimator.onnx`, options);

    console.log("[SUPERTONIC_WORKER_V14] Loading vocoder.onnx...");
    ...
    modelsLoaded = true;
    console.log("[SUPERTONIC_WORKER_V14] Ready.");
}
